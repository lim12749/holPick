...
export const DATASETS: KraDataset[] = [
  ...
  },
  {
    id: "betting-sales",
    label: "매출액 및 확정배당율",
    description: "경주별 승식별 발매금액과 확정배당 — 복승 ROI 계산의 근거",
    envKey: "KRA_EP_BETTING_SALES",
    defaultPath: "API179_1/salesAndDividendRate_1",
    baseEnvKey: "KRA_API_BASE_URL",
    portalUrl: "https://www.data.go.kr/data/15057896/openapi.do",
    group: "race",
    meetCodes: MEET_WITH_YEONGCHEON,
    preferredColumns: ["rcDate", "rcNo", "pool", "odds", "amt"],
  },
  {
    id: "betting-odds",
    label: "승식별 최고배당률",
    description: "역대 최고 배당 기록. 날짜 필터가 듣지 않아 예측 가치는 낮다",
    envKey: "KRA_EP_BETTING_ODDS",
    defaultPath: "API35_1/highestDividendRateInfo_1",
    baseEnvKey: "KRA_API_BASE_URL",
    portalUrl: "https://www.data.go.kr/data/15059267/openapi.do",
    group: "race",
    meetCodes: MEET_STANDARD,
    preferredColumns: ["rcDate", "rcNo", "pool", "odds", "chulNo1", "chulNo2"],
  },
  {
    id: "ai-race-plan",
    label: "AI학습용 경주계획",
