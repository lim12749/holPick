 ...
 */
/**
 * 학습 구간(검증 구간 제외)에서 잰 요인별 단독 예측력에 맞춰 배분했다.
 * 무작위 대비 배수: 각질 1.39 · 부담중량 1.20 · 게이트 1.18 · 휴양 1.18 · 레이팅 1.03.
 *
 * 처음에는 레이팅을 0.30 으로 가장 크게 뒀는데, 실제로 재보니 1.03배로 거의
 * 무의미했다. 마사회 레이팅은 같은 등급끼리 붙는 편성에서 변별력이 낮고
 * 보유율도 73% 에 그친다. 반면 각질이 가장 강한 단일 요인이었다.
 *
 * 최근폼·기수·조교사는 단독 측정을 하지 않아 기존 비중을 유지했다.
 */
